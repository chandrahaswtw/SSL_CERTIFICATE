...
templates['search'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <tr>\r\n                <td scope=\"col\" class=\"counterCell\"></td>\r\n                <td scope=\"col\">"
    ...
    + "</td>\r\n"
    + ((stack1 = (helpers.isStatus || (depth0 && depth0.isStatus) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.expDate : depth0),(depth0 != null ? depth0.thresholdDays : depth0),{"name":"isStatus","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                <td scope=\"col\" id=\""
